...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '../../staticFiles/css/IPHONE/images/nicEditorIcons.gif',
...
var nicImageButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		...
		this.addForm({
			...
			'align' : {type : 'select', txt : 'Align', options : {'center' : 'Center','left' : 'Left', 'right' : 'Right'}}
		},this.im);
	},
	
	submit : function(e) {
		var src = this.inputs['src'].value;
		var align = this.inputs['align'].value;
		...
		if(src == "" || src == "http://") {
			...
			alert("You must set a align property");
			return false;
		}
